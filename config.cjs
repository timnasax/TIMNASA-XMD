...
const config = {
  ...
  ANTI_LINK: process.env.ANTI_LINK: !==undefined ? process.env.ANTI_LINK == 'true' :false,
  ...
  BOT_NAME: process.env.BOT_NAME || "TimnasaTech",
  MENU_IMAGE: process.env.MENU_IMAGE || "https://files.catbox.moe/jmyv02.jpg",
  DESCRIPTION: process.env.DESCRIPTION || "TimnasaTech",
